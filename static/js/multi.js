...
const color5 =[["black","black","black","black","black"],
               ...
               ["black","black","black","black","black"],
               ["black","black","black","black","black"]];
var move=0 ,s=0,score1,score2,move1,move2;
...
{ document.getElementById("win").style.display = "block";
  ...
  if (score1>score2)
  { document.getElementById("message1").innerText=" PLAYER 1 WINS!!" ;
    document.getElementById("message2").innerText="SCORE : "+score1;
    document.getElementById("message").innerText="MOVES : "+move1;
  }
  if (score1<score2)
  { document.getElementById("message1").innerText=" PLAYER 2 WINS!!" ;
    document.getElementById("message2").innerText="SCORE : "+score2;
    document.getElementById("message").innerText="MOVES : "+move2;
  }  
  if (score1==score2)
   { document.getElementById("message1").innerText=" TIE" ;
     document.getElementById("message2").innerText="TRY AGAIN!!";
